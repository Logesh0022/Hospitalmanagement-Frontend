      ...
      {isAdmin && (
        <form className="content-card form-card" onSubmit={add}>
          ...
          <div className="form-grid">
            ...
            <input className="plain-input" name="age" placeholder="Age" type="number" value={form.age} onChange={change} />

            <select className="plain-input" name="gender" value={form.gender} onChange={change}>
              <option>Male</option>
              <option>Female</option>
              <option>Other</option>
            </select>

            <input className="plain-input" name="bloodGroup" placeholder="Blood Group" value={form.bloodGroup} onChange={change} />
          </div>

          <input className="plain-input" name="address" placeholder="Address" value={form.address} onChange={change} />
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              ...
              {patients.length === 0 && (
                <tr>
                  <td colSpan={isAdmin ? 5 : 4}>No patients found</td>
                </tr>
              )}
            </tbody>
          </table>
